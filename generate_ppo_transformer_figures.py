...
def generate_figure7(training_data, eval_baseline, eval_noisy):
    ...
    output_dir = Path('article/Rys')
    output_dir.mkdir(parents=True, exist_ok=True)
    plt.savefig(output_dir / 'R7.png', dpi=300, bbox_inches='tight')
    plt.savefig(output_dir / 'R7.pdf', bbox_inches='tight')
    print(f"✓ Zapisano: {output_dir / 'R7.png'} i {output_dir / 'R7.pdf'}")
    plt.close()
...
def generate_figure8(eval_baseline, eval_noisy):
    ...
    plt.savefig(output_dir / 'R8.pdf', bbox_inches='tight', pad_inches=0.2)
    print(f"✓ Zapisano: {output_dir / 'R8.png'} i {output_dir / 'R8.pdf'}")
    plt.close()
